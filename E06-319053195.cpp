...
// average normals
	GLfloat cubo_vertices[] = {
		...
		// bottom
		//x		y		z		S		T
		-0.5f, -0.5f,  0.5f,	0.51f,  0.98f,		0.0f,	1.0f,	0.0f,
		...
		//UP
		 //x		y		z		S		T
		 -0.5f, 0.5f,  0.5f,	0.51f,  0.343f,		0.0f,	-1.0f,	0.0f,
		 0.5f,  0.5f,  0.5f,	0.74f,	0.343f,		0.0f,	-1.0f,	0.0f,
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado_cars.jpg");
