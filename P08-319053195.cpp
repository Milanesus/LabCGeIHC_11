...
int main()
{
	...
	Nuclear_M = Model();
	Nuclear_M.LoadModel("Models/Nuclear_obj.obj");
	...
	//Luz puntual del hielo de la Bomba Nuclear
	pointLights[1] = PointLight(0.0f, 0.0f, 0.8f,
		//Intensidad ambiental y tonalidad
		2.5f, 2.5f,
		//Abajo posiciones x, y, z
		-20.0f, 0.0f, 0.0f,
	...
	//Segundo arreglo de PointLights
	...
	//Luz Faro
	spotLights2[2] = SpotLight(1.0f, 1.0f, 0.0f,
		1.0f, 2.0f,
		//Posicion de la luz
		2.75f, 5.8f, 9.5f,
		//Dirección de la luz
	...
	*/	
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Ejercicio 2
		if (mainWindow.getarticulacion4() == 1.0f) {
		...
		//Ejercicio 3
		bandera = mainWindow.getarticulacion5();
		bandera2 = mainWindow.getarticulacion6();
		...
		spotLights[1].SetFlash(glm::vec3(model * glm::vec4(0.0f, 8.1f, 6.3f, 1.0f)), glm::normalize(glm::vec3(model * glm::vec4(0.0f, -0.6f, 1.0f, 0.0f))));
		spotLights2[1].SetFlash(glm::vec3(model * glm::vec4(0.0f, 8.1f, 6.3f, 1.0f)), glm::normalize(glm::vec3(model * glm::vec4(0.0f, -0.6f, 1.0f, 0.0f))));
		spotLights3[1].SetFlash(glm::vec3(model * glm::vec4(0.0f, 8.1f, 6.3f, 1.0f)), glm::normalize(glm::vec3(model * glm::vec4(0.0f, -0.6f, 1.0f, 0.0f))));
		...
		spotLights2[2].SetFlash(glm::vec3(model * glm::vec4(2.75f, 0.4f, -1.0f, 1.0f)), glm::normalize(glm::vec3(model * glm::vec4(0.0f, -0.25f, 0.9f, 0.0f))));
		...
		//Luz que se mueve con el carro
		spotLights3[2].SetFlash(glm::vec3(model * glm::vec4(3.2f, 1.2f, 4.0f, 1.0f)), glm::normalize(glm::vec3(model * glm::vec4(0.0f, -0.25f, -0.9f, 0.0f))));
		...
		//Bomba Nuclear
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-20.0f, 7.0f, 0.0f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Nuclear_M.RenderModel();
